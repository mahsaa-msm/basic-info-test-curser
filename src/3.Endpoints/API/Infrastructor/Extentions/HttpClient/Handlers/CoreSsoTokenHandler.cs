...
public sealed class CoreSsoTokenHandler : DelegatingHandler
{
    private readonly ILogger<CoreSsoTokenHandler> _logger;
    private readonly ICacheAdapter _cacheAdapter;
    private readonly ICoreSsoGetTokenCaller _coreSsoGetTokenCaller;

    public CoreSsoTokenHandler(ILogger<CoreSsoTokenHandler> logger,
