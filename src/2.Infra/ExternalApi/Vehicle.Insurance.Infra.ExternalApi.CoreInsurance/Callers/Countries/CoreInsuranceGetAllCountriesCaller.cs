...
public sealed class CoreInsuranceGetAllCountriesCaller : ICoreInsuranceGetAllCountriesCaller, ITransientLifetime
{
    ...
    public CoreInsuranceGetAllCountriesCaller(IHttpClientFactory httpClientfactory,
    ...
    public async Task<Response<BaseCoreInsuranceResponse<GetAllCountriesResponse>>> Call(GetAllCountriesRequest request)
    {
