...
public sealed class FetchLicensePlateTypesFromSourceHandler : CommandHandler<FetchLicensePlateTypesFromSourceCommand>
{
    ...
    public FetchLicensePlateTypesFromSourceHandler(ZaminServices zaminServices,
    ...
    public override async Task<CommandResult> Handle(FetchLicensePlateTypesFromSourceCommand command)
    {
        ...
        foreach (var item in items)
        {
            ...
            var updateParameter = new UpdateLicensePlateTypeParameter(
                title,
                DIPTitle.FromString(rawTitle),
                existing.Priority);
