...
public sealed class FetchMultiTenantVehicleColorsFromSourceHandler : CommandHandler<FetchMultiTenantVehicleColorsFromSourceCommand>
{
    ...
    public FetchMultiTenantVehicleColorsFromSourceHandler(ZaminServices zaminServices,
    ...
    public override async Task<CommandResult> Handle(FetchMultiTenantVehicleColorsFromSourceCommand command)
    {
