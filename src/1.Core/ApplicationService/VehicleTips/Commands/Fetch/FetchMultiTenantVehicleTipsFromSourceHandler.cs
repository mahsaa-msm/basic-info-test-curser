...
public sealed class FetchMultiTenantVehicleTipsFromSourceHandler
    : CommandHandler<FetchMultiTenantVehicleTipsFromSourceCommand>
{
    ...
    public FetchMultiTenantVehicleTipsFromSourceHandler(ZaminServices zaminServices,
    ...
    public override async Task<CommandResult> Handle(FetchMultiTenantVehicleTipsFromSourceCommand command)
    {
