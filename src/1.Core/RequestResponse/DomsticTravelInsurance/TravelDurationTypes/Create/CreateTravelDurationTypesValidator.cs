...
public class CreateTravelDurationTypesValidator : AbstractValidator<CreateTravelDurationTypesCommand>
{
    public CreateTravelDurationTypesValidator(ITranslator translator)
    {
        RuleFor(x => x.Title)
