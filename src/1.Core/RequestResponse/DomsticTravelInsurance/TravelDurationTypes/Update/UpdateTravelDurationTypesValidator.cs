...
public class UpdateTravelDurationTypesValidator : AbstractValidator<UpdateTravelDurationTypesCommand>
{
    public UpdateTravelDurationTypesValidator(ITranslator translator)
    {
        RuleFor(x => x.Id)
