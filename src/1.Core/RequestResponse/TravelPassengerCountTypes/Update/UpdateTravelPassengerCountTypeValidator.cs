...
public class UpdateTravelPassengerCountTypeValidator : AbstractValidator<UpdateTravelPassengerCountTypeCommand>
{
    public UpdateTravelPassengerCountTypeValidator(ITranslator translator)
    {
        RuleFor(x => x.Id)
          .Cascade(CascadeMode.Stop)
          .NotEmpty()
          .WithMessage(translator[ProjectValidationError.VALIDATION_ERROR_REQUIRED, ProjectTranslation.ID])
