...
public sealed class CreateLicensePlateTypeValidator : AbstractValidator<CreateLicensePlateTypeCommand>
{
    public CreateLicensePlateTypeValidator(ITranslator translator)
    {
